...
import { AuthorLineCharts } from './AuthorLineCharts';
...
describe('AuthorLineCharts', () => {
  it('renders without crashing with empty data', () => {
    const { container } = renderWithProviders(
      <AuthorLineCharts flattenedData={[]} styleOptions={{ width: '100%', height: '400px' }} searchTerm="" onInsightsGenerated={() => {}} />
    );
  ...
  it('renders without crashing with mock data', () => {
    ...
    const { container } = renderWithProviders(
      <AuthorLineCharts flattenedData={mockData} styleOptions={{ width: '100%', height: '400px' }} searchTerm="" onInsightsGenerated={() => {}} />
    );
    expect(container).toBeTruthy();
  });
});
